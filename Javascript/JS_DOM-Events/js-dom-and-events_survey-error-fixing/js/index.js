...
// the button is shown active. However,
// the debug message doesn't appear in the debug console.
...
// 4. When clicking on the second choice,
// the button should be shown with an active state.
