...
console.log("Rating: ", bookDetails.bookRating);
console.log("Sales: ", bookDetails.noOfCopies);

bookDetails.bookRating = 4;
bookDetails.noOfCopies += 900;
...
// --v-- write your code here --v--
function logBookData(bookDetails) {
  console.log("Title: ", bookDetails.bookTitle);
  console.log("Author: ", bookDetails.author);
  console.log("Rating: ", bookDetails.bookRating);
  console.log("Sales: ", bookDetails.noOfCopies);
}
bookDetails.bookRating = 10;
bookDetails.noOfCopies += 999999;

logBookData(bookDetails);
// --^-- write your code here --^--
